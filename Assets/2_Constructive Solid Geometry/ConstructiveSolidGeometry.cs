...
public class ConstructiveSolidGeometry : MonoBehaviour
{
    class TraceResult
    {
    ...
    public Vector4 m_Geo2 = new Vector4(0.3f, 0.7f, 0.05f,0.8f);
    public Vector4 m_Geo3 = new Vector4(0.7f, 0.5f, 0.10f,0.0f);
    ...
    private TraceResult scene(float x,float y)
    {
        ...
        {
            sd = circleSDF(x, y, m_Geo2.x, m_Geo2.y, m_Geo2.z),
            emissive = m_Geo2.w
        };

//         TraceResult tr3 = new TraceResult
//         {
//             sd = circleSDF(x, y, m_Geo3.x, m_Geo3.y, m_Geo3.z),
//             emissive = m_Geo3.w
//         };
